...
class LocationExceptionTest {
	...
	public void testConstructorAndGetMessage() {
		...
		LocationException exception = new LocationException(errorMessage);
	...
	public void testResponseStatusAnnotation() {
		ResponseStatus responseStatus = LocationException.class.getAnnotation(ResponseStatus.class);
